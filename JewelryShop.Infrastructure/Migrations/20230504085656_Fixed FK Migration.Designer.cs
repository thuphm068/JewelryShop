...
namespace JewelryShop.Infrastructure.Migrations
{
    ...
    [Migration("20230504085656_Fixed FK Migration")]
    partial class FixedFKMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JewelryShop.Domain.Entities.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JewelryShop.Domain.Entities.Cart", b =>
                {
                    b.HasOne("JewelryShop.Domain.Entities.Customer", null)
                        .WithOne()
                        .HasForeignKey("JewelryShop.Domain.Entities.Cart", "CustomerId")
            ...
            modelBuilder.Entity("JewelryShop.Domain.Entities.Product", b =>
                {
                    b.HasOne("JewelryShop.Domain.Entities.SubCategory", null)
                        .WithMany()
